...
if not defined DICOMSDL_CODEC_JPEG_MODE set "DICOMSDL_CODEC_JPEG_MODE=builtin"
if not defined DICOMSDL_CODEC_JPEGLS_MODE set "DICOMSDL_CODEC_JPEGLS_MODE=builtin"
if not defined DICOMSDL_CODEC_JPEG2K_MODE set "DICOMSDL_CODEC_JPEG2K_MODE=builtin"
if not defined DICOMSDL_CODEC_HTJ2K_MODE set "DICOMSDL_CODEC_HTJ2K_MODE=builtin"
if not defined DICOMSDL_CODEC_JPEGXL_MODE set "DICOMSDL_CODEC_JPEGXL_MODE=builtin"
