...
"${PYTHON_BIN}" "${DICT_DIR}/generate_lookup_tables.py" --registry "${DICT_DIR}/_dataelement_registry.tsv" --output "${ROOT_DIR}/include/dictionary_lookup_tables.hpp"
...
echo "[6/6] Extracting Part 03 Specific Character Sets -> _specific_character_sets.tsv"
