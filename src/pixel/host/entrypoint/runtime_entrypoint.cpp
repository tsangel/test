...
::pixel::runtime_v2::Htj2kDecoderBackendPreference to_runtime_backend(
    Htj2kDecoderBackend backend) {
  switch (backend) {
  case Htj2kDecoderBackend::openjph:
    return ::pixel::runtime_v2::Htj2kDecoderBackendPreference::kOpenJph;
  case Htj2kDecoderBackend::openjpeg:
    return ::pixel::runtime_v2::Htj2kDecoderBackendPreference::kOpenJpeg;
  case Htj2kDecoderBackend::auto_select:
  default:
    return ::pixel::runtime_v2::Htj2kDecoderBackendPreference::kAuto;
  }
}

Htj2kDecoderBackend from_runtime_backend(
    ::pixel::runtime_v2::Htj2kDecoderBackendPreference backend) {
  switch (backend) {
  case ::pixel::runtime_v2::Htj2kDecoderBackendPreference::kOpenJph:
    return Htj2kDecoderBackend::openjph;
  case ::pixel::runtime_v2::Htj2kDecoderBackendPreference::kOpenJpeg:
    return Htj2kDecoderBackend::openjpeg;
  case ::pixel::runtime_v2::Htj2kDecoderBackendPreference::kAuto:
  default:
...
bool set_htj2k_decoder_backend(Htj2kDecoderBackend backend, std::string* out_error) {
  return ::pixel::runtime_v2::set_htj2k_decoder_backend_preference(
      to_runtime_backend(backend), out_error);
}

Htj2kDecoderBackend get_htj2k_decoder_backend() {
  return from_runtime_backend(
      ::pixel::runtime_v2::get_htj2k_decoder_backend_preference());
}
...
bool clear_external_codec_plugins(std::string* out_error) {
  return ::pixel::runtime_v2::clear_external_codec_plugins(out_error);
}
