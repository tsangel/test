...
enum class HostModalityValueTransformKindV2 : uint8_t {
  kNone = 0,
  kRescale = 1,
  kModalityLut = 2,
};

struct HostModalityValueTransformV2 {
  HostModalityValueTransformKindV2 kind{HostModalityValueTransformKindV2::kNone};
...
pixel_error_code_v2 decode_frame_with_host_context_v2(HostDecoderContextV2* ctx,
    ...
    const HostModalityValueTransformV2* modality_value_transform = nullptr);
