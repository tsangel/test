...
pixel_error_code validate_encoder_request(EncoderCtx* ctx,
...
pixel_error_code encoder_encode_frame_to_context_buffer(
  ...
  const pixel_error_code validate_ec = validate_encoder_request(c, request,
  ...
  const pixel_error_code encode_ec = build_rle_codestream(c,
