...
PIXEL_PLUGIN_EXPORT int pixel_get_decoder_plugin_api_v2(
  ...
  api.info.display_name = "OpenJPEG v2 Decoder";
  api.info.supported_profile_flags = pixel::openjpeg_codec_v2::supported_profile_flags();
  api.create = &pixel::openjpeg_codec_v2::decoder_create;
  api.destroy = &pixel::openjpeg_codec_v2::decoder_destroy;
  api.configure = &pixel::openjpeg_codec_v2::decoder_configure;
  api.decode_frame = &pixel::openjpeg_codec_v2::decoder_decode_frame;
  api.copy_last_error_detail = &pixel::openjpeg_codec_v2::decoder_copy_last_error_detail;
  *out_api = api;
  return 1;
}
...
PIXEL_PLUGIN_EXPORT int pixel_get_encoder_plugin_api_v2(
  ...
  api.info.display_name = "OpenJPEG v2 Encoder";
  api.info.supported_profile_flags = pixel::openjpeg_codec_v2::supported_profile_flags();
  api.create = &pixel::openjpeg_codec_v2::encoder_create;
  api.destroy = &pixel::openjpeg_codec_v2::encoder_destroy;
  api.configure = &pixel::openjpeg_codec_v2::encoder_configure;
  api.encode_frame = &pixel::openjpeg_codec_v2::encoder_encode_frame;
  api.copy_last_error_detail = &pixel::openjpeg_codec_v2::encoder_copy_last_error_detail;
  api.encode_frame_to_context_buffer =
      &pixel::openjpeg_codec_v2::encoder_encode_frame_to_context_buffer;
  api.get_encoded_buffer = &pixel::openjpeg_codec_v2::encoder_get_encoded_buffer;
  *out_api = api;
  return 1;
}
