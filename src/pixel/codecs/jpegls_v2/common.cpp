...
constexpr pixel_supported_profile_flags_v2 kSupportedProfileFlags =
    PIXEL_CODEC_PROFILE_JPEGLS_LOSSLESS_DEC_V2 |
    PIXEL_CODEC_PROFILE_JPEGLS_NEAR_LOSSLESS_DEC_V2 |
    PIXEL_CODEC_PROFILE_JPEGLS_LOSSLESS_ENC_V2 |
    PIXEL_CODEC_PROFILE_JPEGLS_NEAR_LOSSLESS_ENC_V2;
...
pixel_error_code_v2 encoder_configure(void* ctx, uint32_t codec_profile_code,
  ...
  c->near_lossless_error =
      (codec_profile_code == PIXEL_CODEC_PROFILE_JPEGLS_LOSSLESS_V2) ? 0 : 1;
  ...
  if (codec_profile_code == PIXEL_CODEC_PROFILE_JPEGLS_LOSSLESS_V2 &&
