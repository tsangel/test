...
int build_decoder_plugin_api(pixel_decoder_plugin_api* out_api) {
  ...
  api.info.display_name = "JPEG-LS Decoder";
  api.info.supported_profile_flags = pixel::jpegls_codec::supported_profile_flags();
  api.create = &pixel::jpegls_codec::decoder_create;
  api.destroy = &pixel::jpegls_codec::decoder_destroy;
  api.configure = &pixel::jpegls_codec::decoder_configure;
  api.decode_frame = &pixel::jpegls_codec::decoder_decode_frame;
  api.copy_last_error_detail = &pixel::jpegls_codec::decoder_copy_last_error_detail;
  *out_api = api;
  return 1;
}
...
int build_encoder_plugin_api(pixel_encoder_plugin_api* out_api) {
  ...
  api.info.display_name = "JPEG-LS Encoder";
  api.info.supported_profile_flags = pixel::jpegls_codec::supported_profile_flags();
  api.create = &pixel::jpegls_codec::encoder_create;
  api.destroy = &pixel::jpegls_codec::encoder_destroy;
  api.configure = &pixel::jpegls_codec::encoder_configure;
  api.encode_frame = &pixel::jpegls_codec::encoder_encode_frame;
  api.copy_last_error_detail = &pixel::jpegls_codec::encoder_copy_last_error_detail;
  api.encode_frame_to_context_buffer =
      &pixel::jpegls_codec::encoder_encode_frame_to_context_buffer;
  api.get_encoded_buffer = &pixel::jpegls_codec::encoder_get_encoded_buffer;
  *out_api = api;
  return 1;
}
