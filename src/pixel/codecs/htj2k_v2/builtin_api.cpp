...
const pixel_decoder_plugin_api_v2& decoder_builtin_api() noexcept {
  static const pixel_decoder_plugin_api_v2 api = []() {
    ...
    out.info.display_name = "HTJ2K v2 Decoder (builtin)";
    out.info.supported_profile_flags = pixel::htj2k_codec_v2::supported_profile_flags();
    out.create = &pixel::htj2k_codec_v2::decoder_create;
    out.destroy = &pixel::htj2k_codec_v2::decoder_destroy;
    out.configure = &pixel::htj2k_codec_v2::decoder_configure;
    out.decode_frame = &pixel::htj2k_codec_v2::decoder_decode_frame;
    out.copy_last_error_detail = &pixel::htj2k_codec_v2::decoder_copy_last_error_detail;
    return out;
  }();
  return api;
}
...
const pixel_encoder_plugin_api_v2& encoder_builtin_api() noexcept {
  static const pixel_encoder_plugin_api_v2 api = []() {
    ...
    out.info.display_name = "HTJ2K v2 Encoder (builtin)";
    out.info.supported_profile_flags = pixel::htj2k_codec_v2::supported_profile_flags();
    out.create = &pixel::htj2k_codec_v2::encoder_create;
    out.destroy = &pixel::htj2k_codec_v2::encoder_destroy;
    out.configure = &pixel::htj2k_codec_v2::encoder_configure;
    out.encode_frame = &pixel::htj2k_codec_v2::encoder_encode_frame;
    out.copy_last_error_detail = &pixel::htj2k_codec_v2::encoder_copy_last_error_detail;
    out.encode_frame_to_context_buffer =
        &pixel::htj2k_codec_v2::encoder_encode_frame_to_context_buffer;
    out.get_encoded_buffer = &pixel::htj2k_codec_v2::encoder_get_encoded_buffer;
    return out;
  }();
  return api;
}
