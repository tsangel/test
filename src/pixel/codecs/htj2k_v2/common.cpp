...
constexpr pixel_supported_profile_flags_v2 kSupportedProfileFlags =
    PIXEL_CODEC_PROFILE_HTJ2K_LOSSLESS_DEC_V2 |
    PIXEL_CODEC_PROFILE_HTJ2K_LOSSLESS_RPCL_DEC_V2 |
    PIXEL_CODEC_PROFILE_HTJ2K_LOSSY_DEC_V2 |
    PIXEL_CODEC_PROFILE_HTJ2K_LOSSLESS_ENC_V2 |
    PIXEL_CODEC_PROFILE_HTJ2K_LOSSLESS_RPCL_ENC_V2 |
    PIXEL_CODEC_PROFILE_HTJ2K_LOSSY_ENC_V2;
