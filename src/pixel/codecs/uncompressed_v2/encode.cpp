...
pixel_error_code_v2 validate_encode_request(ErrorState* state,
...
pixel_error_code_v2 encode_uncompressed_frame(
    ErrorState* state, const pixel_encoder_request_v2* request) {
  DtypeInfo source_dtype{};
  ...
  const pixel_error_code_v2 validate_ec = validate_encode_request(state, request,
  ...
  mutable_request->output.encoded_size = encoded_frame_size_u64;
