...
DICOMSDL_MSVC_ENABLE_LTCG="${DICOMSDL_MSVC_ENABLE_LTCG:-ON}"
DICOMSDL_MSVC_PGO="${DICOMSDL_MSVC_PGO:-OFF}"
DICOMSDL_MSVC_PGO_DIR="${DICOMSDL_MSVC_PGO_DIR:-${ROOT_DIR}/build-pgo/msvc}"
