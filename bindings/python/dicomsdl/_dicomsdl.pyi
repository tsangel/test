...
class _SegmentsOverlap(enum.Enum):
    unknown = ...
    no = ...
    yes = ...
    undefined = ...
...
class _SegmentFrame:
    ...
    def to_array(self) -> Any:
        """Decode as stored representation: BINARY uint8 0/1, FRACTIONAL raw uint8, LABELMAP uint8 or native uint16."""
        ...
    def decode_frame(self) -> bytes:
        """Return validated native typed sample bytes; 16-bit LABELMAP bytes are native-endian uint16 samples."""
        ...
    def decode_frame_into(self, out: Any, /) -> Any:
        """Decode into a writable C-contiguous unsigned buffer; errors may leave out partially written."""
        ...
    def mask_for_segment(
        ...
        *,
        ...
        """Return a semantic uint8 0/1 mask for one segment across BINARY, FRACTIONAL, and LABELMAP."""
        ...
...
class _Segmentation:
    ...
    @property
    def segments_overlap(self) -> _SegmentsOverlap: ...
    @property
    ...
    def frames_for_segment(self, segment_number: int, /) -> _SegmentFrameList:
        """Return frames where segment_number is present; LABELMAP builds and validates the all-frame index at call time."""
        ...
    def segment_frame_count(self, segment_number: int, /) -> int: ...
    def present_segment_numbers(self, frame: int = ...) -> tuple[int, ...]:
        """Return declared BINARY/FRACTIONAL segment or decoded non-background LABELMAP labels for one frame."""
        ...
...
class _SegModule:
    ...
    SegmentsOverlap: type[_SegmentsOverlap]
