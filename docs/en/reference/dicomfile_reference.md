...
- pixel decode: `create_decode_plan(...)`, `decode_into(...)`, `to_array(...)`, `to_array_view(...)`, `pixel_array(...)`, `pixel_data(...)`
...
- pixel decode: `create_decode_plan(...)`, `decode_into(...)`, `decode_all_frames_into(...)`, `pixel_buffer(...)`, `pixel_data(...)`
