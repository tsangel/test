...
function(dicomsdl_fetch_yyjson)
    if(TARGET dicomsdl_yyjson)
        set(DICOMSDL_YYJSON_TARGET dicomsdl_yyjson PARENT_SCOPE)
        return()
    endif()

    if(TARGET yyjson::yyjson)
        add_library(dicomsdl_yyjson INTERFACE)
        target_link_libraries(dicomsdl_yyjson INTERFACE yyjson::yyjson)
        set(DICOMSDL_YYJSON_TARGET dicomsdl_yyjson PARENT_SCOPE)
        return()
    endif()
    ...
    if(TARGET yyjson)
        add_library(dicomsdl_yyjson INTERFACE)
        target_link_libraries(dicomsdl_yyjson INTERFACE yyjson)
        set(DICOMSDL_YYJSON_TARGET dicomsdl_yyjson PARENT_SCOPE)
        return()
    endif()
    ...
    elseif(TARGET yyjson)
        ...
        message(FATAL_ERROR "yyjson target was not generated")
    endif()
