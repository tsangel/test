...
if not defined DICOMSDL_CODEC_DEFAULT_MODE set "DICOMSDL_CODEC_DEFAULT_MODE=none"
if not defined DICOMSDL_CODEC_JPEG_MODE set "DICOMSDL_CODEC_JPEG_MODE=shared"
if not defined DICOMSDL_CODEC_JPEGLS_MODE set "DICOMSDL_CODEC_JPEGLS_MODE=shared"
if not defined DICOMSDL_CODEC_JPEG2K_MODE set "DICOMSDL_CODEC_JPEG2K_MODE=shared"
if not defined DICOMSDL_CODEC_HTJ2K_MODE set "DICOMSDL_CODEC_HTJ2K_MODE=shared"
if not defined DICOMSDL_CODEC_JPEGXL_MODE set "DICOMSDL_CODEC_JPEGXL_MODE=shared"

if not defined CMAKE_EXTRA_ARGS set "CMAKE_EXTRA_ARGS=-DDICOM_BUILD_PYTHON=OFF -DDICOMSDL_ENABLE_JPEGXL=ON -DDICOMSDL_PIXEL_RLE_STATIC_PLUGIN=OFF -DDICOMSDL_PIXEL_OPENJPEG_STATIC_PLUGIN=OFF -DDICOMSDL_PIXEL_JPEG_STATIC_PLUGIN=OFF -DDICOMSDL_PIXEL_JPEGLS_STATIC_PLUGIN=OFF -DDICOMSDL_PIXEL_HTJ2K_STATIC_PLUGIN=OFF -DDICOMSDL_PIXEL_JPEGXL_STATIC_PLUGIN=OFF -DDICOMSDL_PIXEL_OPENJPEG_PLUGIN=ON -DDICOMSDL_PIXEL_JPEG_PLUGIN=ON -DDICOMSDL_PIXEL_JPEGLS_PLUGIN=ON -DDICOMSDL_PIXEL_HTJ2K_PLUGIN=ON -DDICOMSDL_PIXEL_JPEGXL_PLUGIN=ON"
