...
set "PIXEL_V2_CMAKE_ARGS=-DDICOMSDL_PIXEL_V2_CORE=ON -DDICOMSDL_PIXEL_V2_RUNTIME=ON -DDICOMSDL_PIXEL_V2_RLE_STATIC_PLUGIN=ON -DDICOMSDL_PIXEL_V2_OPENJPEG_STATIC_PLUGIN=ON -DDICOMSDL_PIXEL_V2_JPEG_STATIC_PLUGIN=ON -DDICOMSDL_PIXEL_V2_JPEGLS_STATIC_PLUGIN=ON -DDICOMSDL_PIXEL_V2_HTJ2K_STATIC_PLUGIN=ON"
